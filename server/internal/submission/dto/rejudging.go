...
func (request RejudgingCreateRequest) Selector() submission.RejudgeSelector {
	return submission.RejudgeSelector{
...
func FromRejudging(value submission.Rejudging) RejudgingResponse {
...
func FromRejudgings(values []submission.Rejudging) []RejudgingResponse {
...
func FromRejudgingChanges(values []submission.RejudgingChange) []RejudgingChangeResponse {
