...
INSERT INTO contests AS c (title, description, rule, begin_at, end_at, freeze_at, unfreeze_at,
		 ...
		 VALUES (sqlc.arg(title)::text, sqlc.arg(description)::text, sqlc.arg(rule)::text, sqlc.arg(begin_at)::timestamptz, sqlc.arg(end_at)::timestamptz, sqlc.narg(freeze_at)::timestamptz, sqlc.narg(unfreeze_at)::timestamptz, sqlc.arg(penalty_minutes)::integer, sqlc.arg(penalize_compile_error)::boolean, sqlc.arg(feedback)::text, sqlc.arg(visibility)::text, sqlc.arg(password_hash)::text, sqlc.arg(rankboard_visible)::boolean, sqlc.arg(creator_id)::uuid, sqlc.arg(domain_id)::uuid,sqlc.arg(creator_id)::uuid,sqlc.arg(admission)::text,sqlc.arg(allow_self_registration)::boolean,sqlc.arg(allow_late_registration)::boolean)
...
UPDATE contests AS c SET title = sqlc.arg(title)::text, description = sqlc.arg(description)::text, rule = sqlc.arg(rule)::text, begin_at = sqlc.arg(begin_at)::timestamptz,
		        ...
		        password_hash = CASE
		          ...
		          ELSE ''
		        END,
		        rankboard_visible = sqlc.arg(rankboard_visible)::boolean, admission=sqlc.arg(admission)::text, allow_self_registration=sqlc.arg(allow_self_registration)::boolean, allow_late_registration=sqlc.arg(allow_late_registration)::boolean
