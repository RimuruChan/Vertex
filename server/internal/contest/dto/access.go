...
import "github.com/RimuruChan/Vertex/server/internal/contest"
...
func PermissionsFromDomain(p contest.Permissions) ContestPermissions {
...
func GrantsFromDomain(grants []contest.AccessGrant) []ContestGrantResponse {
