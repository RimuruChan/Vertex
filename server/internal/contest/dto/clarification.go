...
func FromClarification(value contest.Clarification) ClarificationResponse {
...
func FromClarifications(values []contest.Clarification) []ClarificationResponse {
...
func (request ClarificationAskRequest) Input(contestID, authorID string) contest.ClarificationInput {
	return contest.ClarificationInput{
		ContestID: contestID, ProblemID: request.ProblemID, AuthorID: authorID,
		Subject: request.Subject, Body: request.Body,
	}
}

func (request ClarificationReplyRequest) Input(contestID, authorID string) contest.ClarificationInput {
	return contest.ClarificationInput{
