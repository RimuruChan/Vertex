...
func FromGroup(g domain.Group, s domain.Scope) GroupResponse {
	govern := s.CanManageGroup(g) && (s.Allows(domain.ManageGroups) || g.OwnerID == s.UserID)
...
func FromGroups(groups []domain.Group, s domain.Scope) []GroupResponse {
...
func FromGroupMembers(members []domain.GroupMember) []GroupMemberResponse {
