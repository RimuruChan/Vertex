...
func (r *EditorialRepository) ResolveNumber(ctx context.Context, ref string) (string, error) {
	...
	id, err := r.queries.ResolveEditorialNumber(ctx, dbgen.ResolveEditorialNumberParams{DomainID: scope.Domain.ID, PublicID: int64(number)})
