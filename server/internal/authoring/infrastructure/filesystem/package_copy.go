...
func (p *TestdataPublisher) Clone(ctx context.Context, sourceID, targetID string, source authoringdomain.PackageUpload) (_ *authoringdomain.PackageUpload, err error) {
