...
func FromStatement(value authoring.Statement) StatementResponse {
...
func FromStatements(values []authoring.Statement) []StatementResponse {
...
func (request StatementUpsertRequest) Domain(problemID, language string) authoring.Statement {
	return authoring.Statement{
...
func FromFile(value authoring.File) FileResponse {
	return FileResponse{
...
func FromFiles(values []authoring.File) []FileResponse {
...
func (request FileUpsertRequest) Domain(problemID string) authoring.File {
...
func FromTest(value authoring.Test) TestResponse {
	return TestResponse{
...
func FromTests(values []authoring.Test) []TestResponse {
...
func (request TestUpsertRequest) Domain(problemID string, id int64) authoring.Test {
	return authoring.Test{
...
func FromWorkspace(value authoring.Workspace) WorkspaceResponse {
...
func FromTemplates(values []authoring.Template) []TemplateResponse {
