...
func (h *PackageHandler) Publish(c *gin.Context) {
	...
	release, err := h.service.Publish(c.Request.Context(), c.Param("id"), authoring.PublishInput{Revision: *request.Revision, ArtifactVersion: request.ArtifactVersion, Language: request.Language})
	if err != nil {
