...
func (h *PackageHandler) Copy(c *gin.Context) {
	...
	result, err := h.service.Copy(c.Request.Context(), authoring.CopyInput{SourceDomain: request.SourceDomain, SourceProblem: request.SourceProblem, SourceVersion: request.SourceVersion, Attribution: request.Attribution})
	if err != nil {
