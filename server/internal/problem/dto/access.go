...
import "github.com/RimuruChan/Vertex/server/internal/problem"
...
func PermissionsFromDomain(p problem.Permissions) ProblemPermissions {
...
func GrantsFromDomain(grants []problem.AccessGrant) []ProblemGrantResponse {
