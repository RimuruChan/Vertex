...
func (h *ProblemHandler) Get(c *gin.Context) {
	p, err := h.service.Get(c.Request.Context(), c.Param("id"), middleware.CurrentRole(c) == "admin")
	if err != nil {
