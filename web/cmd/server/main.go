...
import (
	...
	_ "github.com/RimuruChan/Vertex/web/docs"
	"github.com/RimuruChan/Vertex/web/internal/config"
	"github.com/RimuruChan/Vertex/web/internal/content"
	contenthandler "github.com/RimuruChan/Vertex/web/internal/content/handler"
	"github.com/RimuruChan/Vertex/web/internal/contest"
	contesthandler "github.com/RimuruChan/Vertex/web/internal/contest/handler"
	"github.com/RimuruChan/Vertex/web/internal/database"
	"github.com/RimuruChan/Vertex/web/internal/identity"
	identityhandler "github.com/RimuruChan/Vertex/web/internal/identity/handler"
	"github.com/RimuruChan/Vertex/web/internal/judge"
	judgehandler "github.com/RimuruChan/Vertex/web/internal/judge/handler"
	"github.com/RimuruChan/Vertex/web/internal/middleware"
	"github.com/RimuruChan/Vertex/web/internal/problem"
	problemhandler "github.com/RimuruChan/Vertex/web/internal/problem/handler"
	"github.com/RimuruChan/Vertex/web/internal/submission"
	submissionhandler "github.com/RimuruChan/Vertex/web/internal/submission/handler"
	api "github.com/RimuruChan/Vertex/web/internal/transport/httpapi"
)
...
func main() {
	...
	go func() {
		slog.Info("vertex web listening", "port", cfg.Port)
