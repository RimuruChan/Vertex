...
export type DtoBuildJobResponse = MockModel<Wire.DtoBuildJobResponse>
export type DtoBuildPackageResponse = MockModel<Wire.DtoBuildPackageResponse>
export type DtoBuildResponse = MockModel<Wire.DtoBuildResponse>
...
export type DtoFileResponse = MockModel<Wire.DtoFileResponse>
...
export type DtoPackageMetaResponse = MockModel<Wire.DtoPackageMetaResponse>
...
export type DtoReleaseResponse = MockModel<Wire.DtoReleaseResponse>
...
export type DtoStatementPreviewResponse = MockModel<Wire.DtoStatementPreviewResponse>
export type DtoStatementResponse = MockModel<Wire.DtoStatementResponse>
...
export type DtoTemplateResponse = MockModel<Wire.DtoTemplateResponse>
export type DtoTestOutcomeResponse = MockModel<Wire.DtoTestOutcomeResponse>
export type DtoTestResponse = MockModel<Wire.DtoTestResponse>
export type DtoTestdataResponse = MockModel<Wire.DtoTestdataResponse>
export type DtoTestdataUploadResponse = MockModel<Wire.DtoTestdataUploadResponse>
...
export type DtoWorkspaceResponse = MockModel<Wire.DtoWorkspaceResponse>
